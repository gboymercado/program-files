 ...
 ***********************************************************/
 ...
 function ajaxChangeQuantityAndGrandTotal(parProductNumber, parUpdatedQuantity, parDifference, parUnitPrice, parAmount){
   ...
   xmlhttp.open('GET'
               ,'Processes/QuantityAndTotal.php?productNumber='+parProductNumber
 ...
 *****************************************************************************/
 ...
 function ajaxRemoveThisCartItem(parProductNumber, parItemCounter){
   ...
   xmlhttp.open('GET','Processes/RemoveOrderItem.php?productNumber='
...
document.getElementById("searchForm").addEventListener("submit", function(event) {
  ...
  let orderNumber = document.getElementById("searchOrderNumber").value;

  // AJAX request to fetch order summary based on order number
  let xhr = new XMLHttpRequest();
  xhr.open("POST", "orderSummary.php", true);
  xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
  xhr.onreadystatechange = function() {
      if (xhr.readyState == 4 && xhr.status == 200) {
          let response = xhr.responseText;
          if (response.trim() !== "") {
              document.getElementById("orderSummaryContainer").innerHTML = response;
