<div class="container">
  <h3 class="text-center mt-2" style="font-family: 'Alata'; padding-top: 30px; padding-bottom: 20px">PRIVACY POLICY</h3>
  <p>Lucas Loaves is committed to providing quality services to you and this policy outlines our ongoing obligations to you in respect of how we manage your Personal Information.
...
A copy of the Australian Privacy Principles may be obtained from the website of The Office of the Australian Information Commissioner at www.aoic.gov.au</p>
  <h4>PERSONAL INFORMATION TERM & COLLECTION</h4>
  <p>Personal Information is information or an opinion that identifies an individual.
    Examples of Personal Information we collect include: names, addresses, email
    addresses, phone and facsimile numbers.</p>
  ...
  <h4>THIRD PARTIES DISCLOSURE OF PERSONAL INFORMATION</h4>
  ...
  <h4>ACCESS TO YOU PERSONAL INFORMATION</h4>
  <p>You may access the Personal Information we hold about you and to update and/or correct it, subject to certain exceptions. If you wish to access your Personal Information, please contact us in writing.
    Luca's Loaves will not charge any fee for your access request, but may charge an administrative fee for providing a copy of your Personal Information.</p>
  ...
  <h4>MAINTAINING YOUR PERSONAL INFORMATION</h4>
