...
<script type="text/javascript">
  ...
  //About Luca's Loaves
  let imageContainer  = createContainerImage("images/aboutUs/photo1.jpg")
  ...
  imageContainer  = createContainerImage("images/aboutUs/lucas.jpg");
  textContainer = createContainerText({
  ...
  //About Luca
  imageContainer  = createContainerImage("images/aboutUs/photo2.jpg");
  textContainer = createContainerText({
                     h3:"About Luca"
